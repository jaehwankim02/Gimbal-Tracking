...
#include "frame.h"
    ...
    #define MISSION_ALT1 5
    #define MISSION_ALT2 5
...
std::vector<std::vector<double>> WPT = {
    ...
    {37.5442341, 127.0784107, MISSION_ALT2}, // end
    {37.5442659, 127.0784259, MISSION_ALT2}, // 여기부터 더미값
    {37.5442659, 127.0784259, MISSION_ALT2}, 
    {37.5442659, 127.0784259, MISSION_ALT2}, 
    {37.5442659, 127.0784259, MISSION_ALT2},
    {37.5442659, 127.0784259, MISSION_ALT2},
    {37.5442659, 127.0784259, MISSION_ALT2},
