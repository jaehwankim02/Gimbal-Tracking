...
static const _SetGuidanceParam_Request_type_support_symbol_names_t _SetGuidanceParam_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rohang25_test, srv, SetGuidanceParam_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rohang25_test, srv, SetGuidanceParam_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rohang25_test, srv, SetGuidanceParam_Request)() {
  return &::rohang25_test::srv::rosidl_typesupport_c::SetGuidanceParam_Request_message_type_support_handle;
}
...
static const _SetGuidanceParam_Response_type_support_symbol_names_t _SetGuidanceParam_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rohang25_test, srv, SetGuidanceParam_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rohang25_test, srv, SetGuidanceParam_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rohang25_test, srv, SetGuidanceParam_Response)() {
  return &::rohang25_test::srv::rosidl_typesupport_c::SetGuidanceParam_Response_message_type_support_handle;
}
...
static const _SetGuidanceParam_type_support_symbol_names_t _SetGuidanceParam_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rohang25_test, srv, SetGuidanceParam)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rohang25_test, srv, SetGuidanceParam)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, rohang25_test, srv, SetGuidanceParam)() {
  return &::rohang25_test::srv::rosidl_typesupport_c::SetGuidanceParam_service_type_support_handle;
}
